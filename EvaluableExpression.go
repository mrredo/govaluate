...
*/
func NewEvaluableExpression(expression string, enableUnexportedChecking ...bool) (*EvaluableExpression, error) {

	functions := make(map[string]ExpressionFunction)
	return NewEvaluableExpressionWithFunctions(expression, functions, enableUnexportedChecking...)
}
...
*/
func NewEvaluableExpressionWithFunctions(expression string, functions map[string]ExpressionFunction, enableUnexportedChecking ...bool) (*EvaluableExpression, error) {
	...
	ret.tokens, err = parseTokens(expression, functions, enableUnexportedChecking...)
	if err != nil {
		return nil, err
	}
